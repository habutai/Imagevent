require 'spec_helper'
#hooray for all these failing tests! I thank you test gods for having such obfuscated code!
describe User do
...
#this needs some working out probably later on
#  it "should accept valid names" do
#    names = %w[username user.name user_name]
#    names.each do |name|
